...
#  --warmup_proportion 0.06 --num_train_epochs 9 --overwrite_output_dir  --save_freq 1   \
...
python main.py   --model_type 'bert' \
 ...
 --max_grad_norm inf \
 --adam_epsilon 1e-6 --adam_beta_2 0.98 --weight_decay 0.01  \
 --warmup_proportion 0.06 --num_train_epochs 1 --overwrite_output_dir  --save_freq 1   \
 --model_descri 'multi_prog'  --task prog_classification   \
 --eval_checkpoint  ./checkpoints_prog/checkpoints/checkpoint_multi_prog/model.pt