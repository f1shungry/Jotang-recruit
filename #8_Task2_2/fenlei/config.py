...
def set_args():
    ...
    parser.add_argument("--train_file", default="E:/AI-Task2-2/NLP-Part2/dataset/train_debug.json", type=str,#./dataset/train_debug.json
    ...
    parser.add_argument('--model_descri', type=str, default = 'model_descri',help='describle the usage of model!')
